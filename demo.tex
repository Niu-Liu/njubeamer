\documentclass[colortheme=light,algorithm,pgfplots]{njubeamer}
...
\begin{document}
    ...
    \begin{fragile}
        \bicolumns{
            \begin{block}{图片}
                \begin{center}
                    \includegraphics[width=0.15\textwidth]{Logos/nju_log.jpg}
                    \includegraphics[width=0.15\textwidth]{Logos/nju_logo_with_name_below_dark.jpg}
                    \includegraphics[width=0.15\textwidth]{Logos/nju_logo_with_name_below_dark.png}
                    \includegraphics[width=0.15\textwidth]{Logos/nju_logo_with_name_below.jpg}\\
                    \includegraphics[width=0.15\textwidth]{Logos/nju_logo_with_name_dark.jpg}
                    \includegraphics[width=0.15\textwidth]{Logos/nju_logo_with_name.jpg}
                \end{center}
            \end{block}
        }{
        \begin{block}{表格}
    ...
    \begin{frame}{}
        \begin{leftbar}
            您可通过如下链接之一获取本\texttt{njubeamer}模板与相应的示例文件：
            \par
            \begin{center}
                \href{https://github.com/Niu-Liu/njubeamer}{https://github.com/Niu-Liu/njubeamer}
                % \par
