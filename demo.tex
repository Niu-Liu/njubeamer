...
\begin{document}
    ...
    \begin{fragile}
        \bicolumns{
            \begin{block}{图片}
                \begin{center}
                    \includegraphics[width=0.2\textwidth]{njubeamer/Logos/nju_log.jpg}
                    \includegraphics[width=0.5\textwidth]{njubeamer/Logos/nju_logo_with_name.jpg} \par
                    \includegraphics[width=0.25\textwidth]{njubeamer/Logos/nju_logo_with_name_below_dark.png}
                    \includegraphics[width=0.25\textwidth]{njubeamer/Logos/nju_logo_with_name_below.jpg}
                \end{center}
            \end{block}
        }{
        \begin{block}{表格}
